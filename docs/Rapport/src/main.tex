...
\begin{center}
\begin{tikzpicture}
\umlclass[x=8, fill=grey!5]{LQViewable}{n : uint \\ t : float}{<<create>>LQViewable() \\}
\umlclass[x=-4,y=-6, fill=grey!5]{LQSurface}{- m_VBO : GLuint\\
    - m_VAO : GLuint\\ 
    - m_FBO : GLuint\\
    - m_shader : LQShader*\\ 
    - m_x : LQNumber\\
...
\umlclass[x=-4, fill=grey!5]{LQuark}{- m_parent : LQuark*\\
...
\umlclass[x=3, fill=grey!5]{LQTexture}{- genTexture(): GLuint \\
    - m_id : GLuint \\
    - m_texWidth : GLuint \\
    - m_texHeight : GLuint \\
    - m_format : GLuint \\
...
\umlclass[x=8, y=-6, fill=grey!5]{LQNumber}{n : int}{}
%\umlclass[x=6, y=-6, fill=grey!5]{LQMathVar}{n : int}{}
%\umlclass[x=2, y=-9, fill=grey!5]{LQMathExpr}{n : int}{}
