...
\begin{tikzpicture}
\begin{comment}
\umlclass[x=8, fill=gray!5]{LQViewable}{
    -- m\_flex : bool\\ 
    -- m\_hidden : bool
}{
    %+ <<create>>LQViewable();\\
...
\umlclass[x=-4,y=-6, fill=gray!5]{LQSurface}{
    -- m\_VBO : GLuint\\
    -- m\_VAO : GLuint\\ 
    -- m\_FBO : GLuint\\
    -- m\_shader : LQShader\\ 
...
\umlclass[x=-6, fill=gray!5]{LQuark}{
    -- m\_parent : LQuark \\
...
\umlclass[x=3, fill=gray!5]{LQTexture}{
    -- m\_id : GLuint \\
    -- m\_texWidth : GLuint \\
    -- m\_texHeight : GLuint \\
    -- m\_format : GLuint \\
...
\begin{comment}
\umlclass[x=8, y=-6, fill=gray!5]{LQNumber}{
    -- m\_quark : LQuark\\
...
\umlclass[x=6, y=-6, fill=gray!5]{LQMathVar}{
    -- m\_number : LQNumber \\
    -- m\_coeff : float \\
    -- m\_next : LQMathVar
}{
...
\umlclass[x=2, y=-9, fill=gray!5]{LQMathExpr}{
