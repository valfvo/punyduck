...
\begin{center}
\begin{tikzpicture}
\umlclass[x=8, fill=grey!5]{LQViewable}{n : uint \\ t : float}{}
\umlclass[y=-3, fill=grey!5]{LQSurface}{d : double}{\umlvirt{setB(b : B) : void je suis un test} \\ getB() : B}
\umlclass[x=-2, fill=grey!5]{LQuark}{n : uint \\ s : string}{}
\umlclass[x=2, fill=grey!5]{LQTexture}{n : uint}{}
\umlclass[x=8, y=-6, fill=grey!5]{LQNumber}{n : uint}{}
\umlclass[x=-2, y=-6, fill=grey!5]{LQMathVar}{n : uint}{}
\umlclass[x=2, y=-6, fill=grey!5]{LQMathExpr}{n : uint}{}
