...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // auto tt = (float)glfwGetTime();
        // transform = glm::rotate(transform, tt, glm::vec3(0.0f, 0.0f, 1.0f)); // Switched the order
        // transform = glm::translate(transform, glm::vec3(0.5f, -0.5f, 0.0f)); // tourner autour cercle
        // transform = glm::rotate(transform, -tt, glm::vec3(0.0f, 0.0f, 1.0f)); // Switched the order
        // transform = glm::translate(transform, glm::vec3(0.5f, -0.5f, 0.0f)); // Switched the order
        // transform = glm::rotate(transform, (float)glfwGetTime(), glm::vec3(0.0f, 0.0f, 1.0f)); // Switched the order

        // // 2 containers version ------------------------------------------------
        // glm::mat4 transform = glm::mat4(1.0f); // make sure to initialize matrix to identity matrix first
        // // first container
        // // ---------------
        // transform = glm::translate(transform, glm::vec3(0.5f, -0.5f, 0.0f));
