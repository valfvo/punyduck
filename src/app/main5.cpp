...
GLuint VAO, VBO;
GLuint textureVBO, textureVAO, textureFBO;

void RenderText(LQShader &shader, std::string text, GLfloat x, GLfloat y, GLfloat scale, glm::vec3 color);
...
int main()
{
    ...
    LQShader shader("text.vs", "text.frag");
    ...
    // =========================================================================
    LQShader textureShader("shaderVertex.txt", "shaderFragment.txt");
    // ======== VBO ==========
    GLfloat s_vertices[54] = {
    ...
    // Configure VBO/VAO for texture quads
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        textureShader.use();
        textureShader.set("model", model);
        textureShader.set("projection", glm::ortho(0.0f, (GLfloat)WIDTH, (GLfloat)HEIGHT, 0.0f, -1.0f, 0.0f));
        textureShader.set("texture0", 0);
